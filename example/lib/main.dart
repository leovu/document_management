...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      setState(() {
        _tokenController.text = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..Jnw1ZZSh7H68bjPAOpD5nwHDFeMKrd6WySSX6PSL_-Y';
