  ...
  Widget build(BuildContext context) {
    ...
    Column(
      children: [
          ...
          child: ListView(
            ...
            children: [
              ...
              if(!widget.isCreatedPassword) Padding(
                ...
                child: AutoSizeText(AppLocalizations.text(LangKey.currentPassword),style: const TextStyle(fontWeight: FontWeight.w600),),
              ),
              if(!widget.isCreatedPassword) Padding(
              ...
              Padding(
                padding: const EdgeInsets.only(bottom: 15.0,left: 15.0,right: 15.0),
                child: AutoSizeText(AppLocalizations.text(LangKey.newPassword),style: const TextStyle(fontWeight: FontWeight.w600),),
              ),
              Padding(
                padding: const EdgeInsets.only(bottom: 20.0,left: 15.0,right: 15.0),
                child: Container(
              ...
              Padding(
                padding: const EdgeInsets.only(bottom: 15.0,left: 15.0,right: 15.0),
                child: AutoSizeText(AppLocalizations.text(LangKey.newPasswordConfirmation),style: const TextStyle(fontWeight: FontWeight.w600),),
              ),
              Padding(
                padding: const EdgeInsets.only(bottom: 20.0,left: 15.0,right: 15.0),
                child: Container(
        ...
        Padding(
          padding: EdgeInsets.only(bottom: MediaQuery.of(context).padding.bottom + 5.0, left: 15.0,right: 15.0),
          child: Container(
            width: MediaQuery.of(context).size.width *0.9,
            height: 40.0,
            decoration: BoxDecoration(
